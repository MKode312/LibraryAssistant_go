    ...
    def CreateStudent(self, request, context):
        try:
            if not request.student_id:
               logger.error("Student ID must not be empty")
               context.set_code(grpc.StatusCode.INVALID_ARGUMENT)
               context.set_details("Student ID must not be empty")
            ...
            if not request.full_name:
                ...
                return students_pb2.CreateStudentResponse()
            if not all(char.lower() in conf.ALLOWED_CHARS for char in request.full_name):
            ...
            if not request.letter:
                ...
                return students_pb2.CreateStudentResponse()
            if not all(char.lower() in conf.ALLOWED_CHARS for char in request.letter):
            ...
            try:
                ...
                context.set_details("Student already exists")
                return students_pb2.CreateStudentResponse()
        except:
    ...
    def GetClass(self, request, context):
        try:
            if request.grade < 1 or request.grade > 11:
                ...
                context.set_code(grpc.StatusCode.INVALID_ARGUMENT)
                context.set_details("Student's grade must be between 1 and 11")
                return students_pb2.GetClassResponse()
            if not request.letter:
                logger.error("Student's grade letter must not be empty")
                context.set_code(grpc.StatusCode.INVALID_ARGUMENT)
                context.set_details("Student's grade letter must not be empty")
            ...
            if len(request.letter.split()) > 1:
                ...
                context.set_details("Student's grade letter must not contain more that 1 word")
                return students_pb2.GetClassResponse()
            students = sdm.GetClassFromDB(request.grade, request.letter)
            if not students:
                logger.error("Student not found")
                context.set_code(grpc.StatusCode.NOT_FOUND)
            ...
            return students_pb2.GetClassResponse(students=students)
        except:
            logger.error("Internal")
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details("Internal")
    ...
    def GetParallel(self, request, context):
        try:
            ...
            if not students:
                ...
                return students_pb2.GetParallelResponse()
            logger.info("Students was received")
            return students_pb2.GetParallelResponse(students=students)
        except:
            logger.error("Internal")
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details("Internal")
    ...
    def UpdateFullNameOfStudent(self, request, context):
        try:
            ...
            try:
                ...
                logger.error("Student's full name must be unique")
                context.set_code(grpc.StatusCode.INVALID_ARGUMENT)
                context.set_details("Student's full name must be unique")
                return students_pb2.UpdateFullNameOfStudentResponse()
        except:
            logger.error("Internal")
            context.set_code(grpc.StatusCode.INTERNAL)
    ...
    def DeleteStudentByID(self, request, context):
        try:
            if not request.student_id:
                ...
                context.set_code(grpc.StatusCode.INVALID_ARGUMENT)
                context.set_details("Student ID must not be empty")
                return students_pb2.DeleteStudentByIDResponse()

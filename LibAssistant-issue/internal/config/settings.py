...
BOOKS_HOST = os.environ.get('BOOKS_HOST', 'books')
BOOKS_PORT = int(os.environ.get('BOOKS_PORT', '40004'))
STUDENTS_HOST = os.environ.get('STUDENTS_HOST', 'students')
STUDENTS_PORT = int(os.environ.get('STUDENTS_PORT', '50052'))

...
<<<<<<< HEAD
=======
	booksCreate "LibAssistant_api/internal/http-server/handlers/books/create"
	booksList "LibAssistant_api/internal/http-server/handlers/books/list"
>>>>>>> 9a622cd (now there is one docker-compose file for the whole project)
...
<<<<<<< HEAD
=======
	router.Get("/books", booksList.New(context.Background(), log, booksClient))
	router.Post("/books", booksCreate.New(context.Background(), log, booksClient))
>>>>>>> 9a622cd (now there is one docker-compose file for the whole project)
